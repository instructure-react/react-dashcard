...
module.exports = React.createClass({
  ...
  getDefaultProps: function () {
    return {
      ...
      closeIcon: DOM.span({style: {fontSize: 25}}, '×'),
      selectedIcon: DOM.span(null, '✓')
    };
  },
  ...
  handleTileClick: function (value) {
    this.commit(value);
    this.close();
  },

  handleTileKeyDown: function (value, event) {
  ...
  renderColorTiles: function () {
    return this.props.defaultColors.map(function (color) {
      ...
      var tileStyle = clone(STYLES.tile);
  ...
  render: function () {
    var previewStyle = clone(STYLES.colorPreview);
