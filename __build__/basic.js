...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libHelpersClone = __webpack_require__(157);

	var _libHelpersClone2 = _interopRequireDefault(_libHelpersClone);

	var _libMain = __webpack_require__(158);
	...
	var App = _react2['default'].createClass({
	  ...
	  handleBackgroundChange: function handleBackgroundChange(idx, color) {
	    this.state.courses[idx].background = color;
	    this.forceUpdate();
	  },

	  renderCourses: function renderCourses() {
	    var firstActionStyle = (0, _libHelpersClone2['default'])(STYLES.action);
	    ...
	    return this.state.courses.map((function (course, idx) {
	      return _react2['default'].createElement(
	        ...
	        {
	          key: idx,
	          closeIcon: _react2['default'].createElement('i', { className: 'fa fa-times', style: { fontSize: 18 } }),
	          selectedIcon: _react2['default'].createElement('i', { className: 'fa fa-check' }),
	          settingsIcon: _react2['default'].createElement('i', { className: 'fa fa-cog', style: { fontSize: 18, opacity: 0.75 } }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactFlipcard = __webpack_require__(160);

	var _reactFlipcard2 = _interopRequireDefault(_reactFlipcard);

	var _CardDetails = __webpack_require__(165);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    ...
	    onBackgroundChange: _react.PropTypes.func
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helpersClassSet = __webpack_require__(162);

	var _helpersClassSet2 = _interopRequireDefault(_helpersClassSet);

	var _helpersContains = __webpack_require__(163);

	var _helpersContains2 = _interopRequireDefault(_helpersContains);

	var _helpersInjectStyle = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helpersClone = __webpack_require__(157);

	var _helpersClone2 = _interopRequireDefault(_helpersClone);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    background: _react.PropTypes.string,
	    onSettingsClick: _react.PropTypes.func.isRequired
	  },

	  getDefaultProps: function getDefaultProps() {
	    return {
	      settingsIcon: _react2['default'].createElement(
	        'span',
	        { style: { fontSize: 25 } },
	        '⚙'
	      )
	  ...
	  render: function render() {
	    var containerStyle = (0, _helpersClone2['default'])(STYLES.container);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isSafari = navigator && /safari/i.test(navigator.userAgent);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    ...
	    defaultColors: _react.PropTypes.arrayOf(_react.PropTypes.string),
	  ...
	  handleTileClick: function handleTileClick(value) {
	    this.commit(value);
	    this.close();
	  },

	  handleTileKeyDown: function handleTileKeyDown(value, event) {
	    if (event.keyCode === 13 /*enter*/ || event.keyCode === 32 /*spacebar*/) {
	      event.preventDefault();
	      this.commit(value);
	      this.close();
	    }
	  ...
	  handleApplyClick: function handleApplyClick() {
	    this.commit(this.refs.input.getDOMNode().value);
	    this.close();
	  },
	  ...
	  renderColorTiles: function renderColorTiles() {
	    return this.props.defaultColors.map((function (color) {
	      var title = color.name + ' (' + color.hex + ')';
	      var selected = color.hex === this.getValue().toUpperCase();
	      var tileStyle = (0, _helpersClone2['default'])(STYLES.tile);
	  ...
	  render: function render() {
	    var previewStyle = (0, _helpersClone2['default'])(STYLES.colorPreview);
